...
class Vehicle {
  ...
  applyBehaviors(target, obstacles) {
    ...
    let snakeForce = this.seekCorrectionSnake(vehicules[0].pos, true, 60);
    let w = this.wander();
    let p = this.prey();
